"""
run_gee_national_watchdog.py -- keeps 08_gee_national_climate.py running
...
Usage:
  python scripts/run_gee_national_watchdog.py                       # all states
...
HEARTBEAT_PATH = ROOT / "logs" / "gee_national_heartbeat.json"
RUN_LOG_DIR = ROOT / "logs"
SCRIPT_PATH = Path(__file__).resolve().parent / "08_gee_national_climate.py"
...
def main() -> int:
    ...
    while True:
        attempt += 1
        log_path = RUN_LOG_DIR / f"gee_national_run_attempt{attempt}.log"
