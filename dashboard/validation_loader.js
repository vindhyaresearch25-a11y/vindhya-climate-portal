...
(function () {
  ...
  function renderFile(file, districtName) {
    ...
    if (!host) return;
    host.className = 'u-scroll-pane'; // reset from the centered .btm-pane-empty card (showEmpty) back to normal block flow for real data
  ...
  function showEmpty(msg) {
    ...
    host.innerHTML = '<i class="fa fa-check-double chart-empty-icon"></i><span>' + msg + '</span>';
  }
