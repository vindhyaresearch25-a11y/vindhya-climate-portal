...
Pradhan Mantri Fasal Bima Yojana (crop insurance) data and research.

Full-text files (`full_text_available: true` in `../index.json`) belong in this folder. Currently: 0.

Metadata-only entries for this category so far: 2 — see `../index.json` (filter by `"category": "pmfby"`).
