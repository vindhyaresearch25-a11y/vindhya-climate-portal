...
PMGSY rural roads and related rural infrastructure data.

Full-text files (`full_text_available: true` in `../index.json`) belong in this folder. Currently: 0.

Metadata-only entries for this category so far: 1 — see `../index.json` (filter by `"category": "infrastructure"`).
